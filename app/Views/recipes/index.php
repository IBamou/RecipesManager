...
<div class="container">
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 2rem;">
        <h1>My Recipes</h1>
        <a href="<?php echo BASE_URL; ?>/recipes/create" class="btn btn-primary"><i class="fas fa-plus"></i> Add Recipe</a>
    </div>
    ...
    <?php if (empty($recipes)): ?>
        <div class="card" style="padding: 4rem; text-align: center;">
            ...
            <p style="color: var(--text-light); margin: 1rem 0;">Start building your cookbook by adding your first recipe!</p>
            <a href="<?php echo BASE_URL; ?>/recipes/create" class="btn btn-primary">Create Your First Recipe</a>
        </div>
    <?php else: ?>
                ...
                <div class="card fade-in-up">
                    ...
                    <div class="card-footer">
                        ...
                        <div style="display: flex; gap: 0.5rem;">
                            <a href="<?php echo BASE_URL; ?>/recipes/edit?id=<?php echo $recipe['id']; ?>" class="btn btn-secondary" style="padding: 0.4rem 0.8rem; font-size: 0.8rem;">Edit</a>
                        </div>
                    </div>
                </div>
            <?php endforeach; ?>
