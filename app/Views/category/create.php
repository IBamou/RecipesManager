...
<head>
  ...
  <title>Add Category - Marrakech Food Lovers</title>
    ...
    <div class="main-content">
      <header class="topbar">
        <div class="topbar-left">
          <h1>Add Category</h1>
          <p>Create a new category for your recipes</p>
        </div>
      ...
      <div class="page-inner">
        <div class="form-page-header">
          ...
          <div>
            <h2 style="font-size:1.6rem;color:var(--text-dark);">Add New Category</h2>
            <p style="font-size:0.85rem;color:var(--text-light);">Create a category to organize your recipes</p>
          </div>
        </div>
          ...
          <form method="POST" action="<?php echo BASE_URL; ?>/categories/create">
            <div class="form-group">
              ...
              <div class="form-input-icon">
                ...
                <input type="text" class="form-input" name="name" placeholder="e.g. Main Course, Desserts, Drinks" required/>
              </div>
            </div>

            <div class="form-group">
              <label>Description</label>
              <textarea class="form-textarea" name="description" rows="4" placeholder="A brief description of this category..."></textarea>
            </div>
            ...
            <div class="form-actions">
              ...
              <button type="submit" class="btn btn-primary">
                <i class="fa fa-floppy-disk"></i> Save Category
              </button>
            </div>
          </form>
        </div>
